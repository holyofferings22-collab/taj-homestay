...
const fieldInput =
  'min-h-[44px] border-0 border-b border-line bg-transparent px-0.5 py-[11px] text-[15px] text-ink outline-none';
...
export function NewsletterForm() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="mt-2 flex min-h-12 cursor-pointer items-center justify-center gap-2.5 rounded-full border-0 bg-blush p-[15px] text-[15px] text-ink transition-colors duration-[250ms] hover:bg-clay hover:text-white"
      >
